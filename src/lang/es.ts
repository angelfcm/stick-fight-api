...
export default {
    ...
    "% must be within: %.": "% debe estar entre: %.",
    "% must be greater than %.": "% debe ser mayor a %.",
    "% already exists with given %.": "% ya existe con el % dado.",
    "% was not found.": "% no fue encontrado.",
    "% must be between % and %.": "% debe estar entre % y %.",
    "Always mode is not valid for this operation.":
        "El modo de siempre no es válido para esta operación.",
    /* Success messages */
    "Operation completed successfully.": "Operación completada con éxito.",
    /* Nouns */
    Page: "La página",
    "Page size": "El tamaño de página",
    "Ranking mode": "El modo de ranking",
    Score: "El puntaje",
